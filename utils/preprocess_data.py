...
def process_raw(raw_data_df, raw_meta_df, binarise_method, shuffle):

    max_scores = raw_meta_df.loc['Max'].astype(float)

    thres_df = thres_score_range(raw_data_df, max_scores)
